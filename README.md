...
- **名字**：EWT360 Helper
- **最新正式版本**: 2.4.1
- **作者**：[ZNink](https://github.com/ZNink) 、 [Lirzh](https://github.com/lirzh) 、[Awesrin2000](https://github.com/wesrin2000)
...
| 时间      | 版本号 | 描述                            |
| --------- | ------ | ------------------------------- |
| 2025.2.27 | 2.3.1 | 更改为播放85%进度自动连播 |
| 2025.2.27 | 2.4.0 | 更新视频播放80%进度自动连播 |
| 2025.2.14 | 2.3.1 | 简化跳题模块代码，适配部分路径 |
| 2025.2.12 | 2.3.0 | 简化、清理部分代码，增加 GUI 保活机制 |
| 2025.2.11 | 2.2.0 | 自动保存配置、初次使用提示遮罩 |
| 2025.2.9 | 2.1.0 | 更新匹配模式，增加调试输出 |
